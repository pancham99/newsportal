...
export default function WriteForUs() {
  return (
    <div className="min-h-screen space-y-4 px-4">
      ...
      <div className="container mx-auto px-9">
        <h2 className="text-2xl font-bold"> Guest post guidelines for buildd</h2>
        <ul className="list-disc pl-5 space-y-2 text-lg mt-4">
          <li>Your article should be original and not published elsewhere.</li>
          <li>Focus on topics related to business, startups, marketing, SEO, remote work, or technology.</li>
          <li>Keep the word count between 800-1500 words.</li>
          <li>Use a clear and engaging writing style.</li>
          <li>Include relevant data, examples, and references to support your points.</li>
          <li>Avoid promotional content or excessive self-promotion.</li>
          <li>Submit your article in a Word document or Google Docs format.</li>
        </ul>
      </div>
      ...
      <div className="container mx-auto px-9 py-5 space-y-3">
        <h3 className="text-2xl font-bold">How to write a well-formatted guest post on TopBriefing</h3>
        <p>Please ensure that your article adheres to the following guidelines:</p>
        <ul className="list-disc pl-5 space-y-2 text-lg mt-4">
          <li>The article must be a minimum of 1200 words in length.</li>
          <li>Use appropriate headings (H2, H3, H4) to structure your article.</li>
          <li>Keep your writing style simple by using short sentences and paragraphs. Each paragraph should consist of no more than 4 to 6 sentences.</li>
          <li>Each sub-section should contain less than 400 words.</li>
          <li>Avoid using jargon, buzzwords, and filler words. Write content that is easy to understand.</li>
          <li>Use bullet points wherever possible to break up dense text.</li>
          <li>Be sure to include source and alt text for all images you use.</li>

        </ul>
      </div>

      <div className="container mx-auto px-9 py-5 space-y-3">
        <h3 className="text-2xl font-bold">List of topics you can write on</h3>
        <p>To maintain the relevance of our content for our readers, we focus on a specific set of topics.

          If you are interested in submitting a guest post, we welcome content on the following subjects:</p>
        <ul className="list-disc pl-5 space-y-2 text-lg mt-4">
          <li>Marketing</li>
          <li>SEO</li>
          <li>Startups</li>
          ...
          <li>Entrepreneurship, Solopreneurship & Indiehacking</li>
          <li>Web Design</li>
      ...
      <div className="container mx-auto px-9 py-5 space-y-3">
        <h4 className="text-2xl font-bold">Our review process</h4>
        <ul className="list-disc pl-5 space-y-2 text-lg mt-4">
          <li>Once we receive your submission, our editorial team will review it for quality, relevance, and adherence to our guidelines.</li>
          <li>If your article meets our criteria, we will notify you via email within 5-7 business days.</li>
          <li>We reserve the right to edit your article for clarity, grammar, and style. You will be informed of any significant changes.</li>
          <li>Once approved, we will schedule your article for publication and provide you with the publication date.</li>
        </ul>
