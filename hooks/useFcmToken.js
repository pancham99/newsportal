      ...
      getFcmMessaging().then((messaging) => {
        if (messaging) {
          unsub = onMessage(messaging, (payload) => {
            ...
            const icon = payload.notification?.icon || payload.data?.icon || "https://www.topbriefing.in/logo-square-badge.png";
            const url = payload.data?.url || payload.fcmOptions?.link || "https://www.topbriefing.in";

            if (Notification.permission === "granted") {
              const notification = new Notification(title, {
                body,
                icon,
                badge: "https://www.topbriefing.in/logo-square-badge.png",
                data: { url }
              });
